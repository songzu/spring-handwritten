 ...
 * @author gengen.wang
 **/
public class SZHandlerAdapter {

    public boolean supports(Object handler) {
        return (handler instanceof SZHandlerMapping);
    }

    public SZModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws InvocationTargetException, IllegalAccessException {
        SZHandlerMapping handlerMapping = (SZHandlerMapping) handler;
        ...
        boolean ifisModelAndView = handlerMapping.getMethod().getReturnType() == SZModelAndView.class;
        if (ifisModelAndView) {
            return (SZModelAndView) result;
        }
